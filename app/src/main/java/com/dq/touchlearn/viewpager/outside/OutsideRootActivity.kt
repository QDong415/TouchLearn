...
class OutsideRootActivity : AppCompatActivity() {

    private lateinit var leftFragment: OutsideLeftFragment
    private lateinit var rightFragment: RightFragment

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_outside_large_viewpager)
    ...
    private fun initView(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null && supportFragmentManager.fragments.size > 2) {
            ...
            leftFragment = supportFragmentManager.fragments[0] as OutsideLeftFragment
            rightFragment = supportFragmentManager.fragments[1] as RightFragment
        } else {
            leftFragment = OutsideLeftFragment()
